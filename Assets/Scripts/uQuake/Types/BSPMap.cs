...
namespace SharpBSP
{
    public class BSPMap
    {
        ...
        private void ReadVertexes()
        {
            ...
            vertexLump.verts = new Vertex[vertCount];
            for (int i = 0; i < vertCount; i++)
                vertexLump.verts[i] = new Vertex(new Vector3(BSP.ReadSingle(), BSP.ReadSingle(), BSP.ReadSingle()),
                    BSP.ReadSingle(), BSP.ReadSingle(), BSP.ReadSingle(), BSP.ReadSingle(),
                    new Vector3(BSP.ReadSingle(), BSP.ReadSingle(), BSP.ReadSingle()), BSP.ReadBytes(4));
        }
